        ...
        <div class="container-fluid">
          <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="index.html"><img class="img-fluid" src="{{ asset('frontend/assets/ic/logo-horizontal-dark.png') }}" width="100"></a>
        ...
        <div class="container">
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                  ...
                  <div class="submenu">
                      <ul>
                          <li class="nav-item"><a class="nav-link" href="pages/ui-features/buttons.html">Artikel</a></li>
