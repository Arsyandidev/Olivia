        ...
        <div class="container">
            <div class="row">
                ...
                <div class="header-img col-6 d-none d-lg-flex align-self-end">
                    <img class="img-fluid ms-auto" src="./assets/illustration/ill-5.png" alt="" width="500px">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-12 col-lg-4 mt-4">
                        <div class="card mx-auto" style="width: 20rem;">
                            <img src="./assets/illustration/no-photo.png" class="card-img-top" alt="...">
                            <div class="card-body">
                                ...
                                <div class="card-act d-flex justify-content-between mt-3">
                                    <a href="article-read-page.html" class="btn btn-primary">Selengkapnya</a>
